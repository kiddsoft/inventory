	...
	<table style="background-color:aliceblue;height:100%;width:100%" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td id="sub_0" style="display: none" >
				...
				<table width="80%" align="center">
					<!-- 高度22 设置鼠标选中与离开的背景事件 -->
					<tr><td id="m0" height="22" onmouseover="mouseMov(0,0)" onmouseout="mouseMov(0,1)">
							<a href="commodity.do?command=view" target="right" class="sub1"><bean:message key="show.all"/></a>
					</td></tr>
					
					<tr><td height="22" onmouseover="this.style.backgroundColor='#ffffff'" onmouseout="this.style.backgroundColor=''">
							<!-- 链接网址，位置，风格 -->
		...
		<tr>
			<td id="sub_1" style="display: none" >
				<table width="80%" align="center">
					<tr><td id="m1" height="22" onmouseover="mouseMov(1,0)" onmouseout="mouseMov(1,1)">
							<a href="indent.do?command=sellview" target="right" class="sub1"><bean:message key="show.all"/></a>
					</td></tr>
					
					<tr><td height="22" onmouseover="this.style.backgroundColor='#ffffff'" onmouseout="this.style.backgroundColor=''">
							<a href="./sell/sell_select.jsp" target="right"  class="sub1"><bean:message key="indent.add"/></a>
					</td></tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td id="sub_2" style="display: none" >
				<table width="80%" align="center">
					<tr><td id="m1" height="22" onmouseover="mouseMov(1,0)" onmouseout="mouseMov(1,1)">
							<a href="indent.do?command=purchaseview" target="right" class="sub1"><bean:message key="show.all"/></a>
					</td></tr>
				...
				<table width="80%" align="center">
					<tr>
						<td height="22" onmouseover="this.style.backgroundColor='#ffffff'" onmouseout="this.style.backgroundColor=''">
							<a href="./tmp/tmp3.jsp" target="right" class="sub1">要住校啊</a>
						</td>
					</tr>
				</table>
			</td>
		...
		<!-- 大项 -->
		<tr>
			<td onclick="menu(100)" height="33" background="img/m1.jpg" >
				<font class="m1">系统管理</font>
			</td>
		</tr>
		<!-- 子项 -->
		<tr>
			<td id="sub_100" style="display: none" >
				<table width="80%" align="center">
					<tr><td height="22" onmouseover="this.style.backgroundColor='#ffffff'" onmouseout="this.style.backgroundColor=''">
